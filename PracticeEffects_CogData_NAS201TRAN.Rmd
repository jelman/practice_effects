...
title: 'Practice Effects on Cognitive Domain and AFQT Tests: Raw scores adjusted for
  Age 20  AFQT and kept on raw score scale'
author: "Jeremy Elman"
date: '`r Sys.Date()`'
output:
...
calcCogDomains = function(testdat){
  ...
  testdat[['ProcSpeed']] = mean(testdat[c("STRWRAW","STRCRAW","TRL2TLOG","TRL3TLOG")])
  testdat[['ExecTrailsSwitch']] = testdat['TRL4TLOG']
  testdat[['ExecCategorySwitch']] = testdat['CSSACC']
  testdat
}
