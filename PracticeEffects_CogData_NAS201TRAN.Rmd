...
title: 'Practice Effects on Cognitive Tests and AFQT Tests: 
        Adjusted for age 20 AFQT, raw scale score'
author: "Jeremy Elman"
date: '`r Sys.Date()`'
output:
...
```{r, include=F}
# Load data
allDat = read.csv("~/netshare/M/PSYCH/KREMEN/Practice Effect Cognition/data/V1V2_CogData_NASAdj.csv")
...
write.csv(results, '~/netshare/M/PSYCH/KREMEN/Practice Effect Cognition/results/PracEffectValues_NASAdj.csv')
```
