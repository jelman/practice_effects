---
title: 'Group Comparisons for Practice Effects: Matched on Education'
author: "Jeremy Elman"
date: '`r Sys.Date()`'
output:
  html_document:
...
Group comparisons of longitudinal follow-up subjects (V1V2), attrition replacement subjects (V2AR), and drop-out subjects (V1) are listed below. V1V2 and V2AR groups have been matched on Education and age at a ratio of 2:1. V1 and V2AR groups have been matched on Education only at a ratio of 1:1.   
...
vetsaAdminDat = read.csv("/home/jelman/netshare/K/Projects/PracticeEffects/data/PracEffectData_Matched_TEDALL.csv",
                         stringsAsFactors = F)
...
#write.csv(vetsa1AllDat, "/home/jelman/netshare/K/Projects/PracticeEffects/data/GroupComparisons_V1_V1V2_EduMatched.csv")
#write.csv(vetsa2AllDat, "/home/jelman/netshare/K/Projects/PracticeEffects/data/GroupComparisons_V1V2_V2AR_EduMatched.csv")
#write.csv(vetsa1ARAllDat, "/home/jelman/netshare/K/Projects/PracticeEffects/data/GroupComparisons_V1_V2AR_EduMatched.csv")
```
