...
```{r, include=F}
# Load data
allDat = read.csv("/home/jelman/netshare/K/Projects/PracticeEffects/data/CogData_Unadj_Zscored.csv")
...
write.csv(results, '/home/jelman/netshare/K/Projects/PracticeEffects/results/PracEffects_Unadjusted_Zscored_Results.csv')
```
