---
title: 'Practice Effects on Cognitive Domain and AFQT Tests: Matched on Education'
author: "Jeremy Elman"
date: '`r Sys.Date()`'
output:
...
```{r, include=F}
# Load data
allDat = read.csv("/home/jelman/netshare/K/Projects/PracticeEffects/data/PracEffectData_Matched_TEDALL.csv")
...
Subjects were matched to equate Education between groups. VETSA 2 groups (longitudinal subjects and attrition replacements) were matched on Age and TEDALL at a ratio of 2:1. VETSA 1 groups (drop-outs and attrition replacements) were matched only on TEDALL at a ratio of 1:1. 
