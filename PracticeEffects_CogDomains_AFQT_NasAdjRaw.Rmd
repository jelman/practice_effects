---
title: "Practice Effects on Cognitive Domain and AFQT Tests: Adjusted raw scores"
author: "Jeremy Elman"
date: '`r Sys.Date()`'
output:
  pdf_document:
...
```{r, include=F}
# Load data
allDat = read.csv("K:/Projects/PracticeEffects/data/PracEffectData_nas201tran_RawAdj.csv")
...
The scores have been adjusted for age 20 AFQT by regressing the nas201tran variable from each raw test score. VETSA 1 and VETSA 2 scores are then standardized (z-scored) using the mean and SD of VETSA 1 scores. Cognitive domain composites are created by averaging these standardized score within domain.
