---
title: 'Practice Effects on Cognitive Domain and AFQT Tests: Matched on Age 20 AFQT'
author: "Jeremy Elman"
date: '`r Sys.Date()`'
output:
...
```{r, include=F}
# Load data
allDat = read.csv("/home/jelman/netshare/K/Projects/PracticeEffects/data/PracEffectData_Matched_nas201tran.csv")
...
## Matching on Age 20 AFQT  

Subjects were matched to equate Age 20 AFQT between groups. VETSA 2 groups (longitudinal subjects and attrition replacements) were matched on Age and nas201tran at a ratio of 2:1. VETSA 1 groups (drop-outs and attrition replacements) were matched only on nas201tran at a ratio of 1:1. 
