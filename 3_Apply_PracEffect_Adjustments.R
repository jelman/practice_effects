...
#     V1V2 & V1V2V3: t1 -> t2     #
#---------------------------------#
pracEffects_V1V2_V1V2V3_t1t2 = read.csv("/home/jelman/netshare/M/PSYCH/KREMEN/VETSA DATA FILES_852014/a_Practice effect revised cog scores/Practice Effect Cognition/VETSA 3/results/PracEffects_NAS201TRAN_V1V2-V1V2V3-t1t2.csv",
...
#        V1V2V3: t2 -> t3         #
#---------------------------------#
pracEffects_V1V2V3_t2t3 = read.csv("/home/jelman/netshare/M/PSYCH/KREMEN/VETSA DATA FILES_852014/a_Practice effect revised cog scores/Practice Effect Cognition/VETSA 3/results/PracEffects_NAS201TRAN_V1V2V3-t2t3.csv",
                                        row.names=1, stringsAsFactors = F)
...
#        V2V3: t2 -> t3           #
#---------------------------------#
pracEffects_V2V3_t2t3 = read.csv("/home/jelman/netshare/M/PSYCH/KREMEN/VETSA DATA FILES_852014/a_Practice effect revised cog scores/Practice Effect Cognition/VETSA 3/results/PracEffects_NAS201TRAN_V2V3-t2t3.csv",
                                   row.names=1, stringsAsFactors = F)
...
#        V1V3: t1 -> t3           #
#---------------------------------#
pracEffects_V1V3_t1t3 = read.csv("/home/jelman/netshare/M/PSYCH/KREMEN/VETSA DATA FILES_852014/a_Practice effect revised cog scores/Practice Effect Cognition/VETSA 3/results/PracEffects_NAS201TRAN_V2V3-t2t3.csv",
                                 row.names=1, stringsAsFactors = F)
