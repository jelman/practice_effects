...
unadj_df = read.csv("~/netshare/M/VETSA DATA FILES_852014/a_Practice effect revised cog scores/Practice Effect Cognition/V1V2V3/data/V1V2V3_CogData_Unadj_2020-06-17.csv",
                    stringsAsFactors = F)
unadj_df_PEadj = unadj_df
...
#     V1V2 & V1V2V3: t1 -> t2     #
#---------------------------------#
pracEffects_V1V2_V1V2V3_t1t2 = read.csv("~/netshare/M/VETSA DATA FILES_852014/a_Practice effect revised cog scores/Practice Effect Cognition/V1V2V3/results/PracEffects_NAS201TRAN_V1V2-V1V2V3-t1t2_2020-06-17.csv",
...
#        V1V2V3: t2 -> t3         #
#---------------------------------#
pracEffects_V1V2V3_t2t3 = read.csv("~/netshare/M/VETSA DATA FILES_852014/a_Practice effect revised cog scores/Practice Effect Cognition/V1V2V3/results/PracEffects_NAS201TRAN_V1V2V3-t2t3_2020-06-17.csv",
                                        row.names=1, stringsAsFactors = F)
...
#        V2V3: t2 -> t3           #
#---------------------------------#
pracEffects_V2V3_t2t3 = read.csv("~/netshare/M/VETSA DATA FILES_852014/a_Practice effect revised cog scores/Practice Effect Cognition/V1V2V3/results/PracEffects_NAS201TRAN_V2V3-t2t3_2020-06-17.csv",
                                   row.names=1, stringsAsFactors = F)
...
#        V1V3: t1 -> t3           #
#---------------------------------#
pracEffects_V1V3_t1t3 = read.csv("~/netshare/M/VETSA DATA FILES_852014/a_Practice effect revised cog scores/Practice Effect Cognition/V1V2V3/results/PracEffects_NAS201TRAN_V2V3-t2t3_2020-06-17.csv",
                                 row.names=1, stringsAsFactors = F)
...
outname = paste0('~/netshare/M/VETSA DATA FILES_852014/a_Practice effect revised cog scores/Practice Effect Cognition/V1V2V3/data/V1V2V3_CogData_PE_',dstamp,'.csv')
