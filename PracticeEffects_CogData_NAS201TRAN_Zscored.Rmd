...
testVars = c("zMR1COR","zTRL1T","zTRL2T","zTRL3T","zTRL4T","zTRL5T","zCSSACC","zMTXRAW","zCVA1RAW","zCVATOT",
...
calcCogDomains = function(testdat){
  ...
  testdat[['zProcSpeed']] = mean(testdat[c("zSTRWRAW","zSTRCRAW","zTRL2T","zTRL3T")])
  testdat[['zExecTrailsSwitch']] = testdat['zTRL4T']
