...
title: 'Practice Effects on Cognitive Tests and AFQT Tests: 
        Adjusted for education, standardized to VETSA 1'
author: "Jeremy Elman"
date: '`r Sys.Date()`'
output:
...
```{r, include=F}
# Load data
allDat = read.csv("~/netshare/M/PSYCH/KREMEN/Practice Effect Cognition/data/V1V2_CogData_TEDALLAdj_Z.csv")
...
calcPracticeEffect = function(dat, varName, idxS1T2, idxS2T2,idxS1T1ret){
  ...
  varV1 = paste0(varV1,"_zted")
  varV2 = paste0(varV2,"_zted")
...
write.csv(results, '~/netshare/M/PSYCH/KREMEN/Practice Effect Cognition/results/PracEffectValues_TEDALLAdj_Z.csv')
```
