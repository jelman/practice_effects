...
The scores have been adjusted for Education by regressing the (scaled) TEDALL variable from each raw test score. VETSA 1 and VETSA 2 scores are then standardized (z-scored) using the mean and SD of VETSA 1 scores. Cognitive domain composites are created by averaging these standardized score within domain.
