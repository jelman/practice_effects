...
pracEffects = sapply(allVars, function(x) calcPracticeEffect(subsetDat, x, idxS1T2,
                                                          idxS2T2, idxS1T1ret))
...
for(i in 1:nPerm){
    ...
    permResults[i,] = sapply(allVars, function(x) calcPracticeEffect(subsetDat, x, 
                                                      idxS1T2perm,
                                                      idxS2T2perm,
                                                      idxS1T1retperm))
}
...
set.seed(21)
boot.out = boot(subsetDat, statistic=bootPracticeEffect, strata=subsetDat$VETSAGRP, R=10000)
...
# write.csv(results, '/home/jelman/netshare/K/Projects/PracticeEffects/results/PracEffects_NAS201TRAN_Results.csv')
```
